	...
	function initialize() {
		...
		var contentStringAbq = '<div id="content0">' +
					...
					'<p>Albuquerque, New Mexico ( Lat:35.0844909; Lng=-106.6511367)</p>' +
		...
		var contentStringRioSenda = '<div id="content1">' +
					...
					'<p><b>ECE536_DManzanares: </b></p>' +
					'<p>My House ( Lat:35.0288; Lng=-106.7429)</p>' +
		...
		var contentStringRioChama = '<div id="content2">' +
					...
					'<p><b>ECE536_DManzanares: </b></p>' +
					'<p>Rio Chama, New Mexico ( Lat:36.1513; Lng=-106.1697)</p>' +
		...
		var contentStringDenver = '<div id="content3">' +
					...
					'<p><b>ECE536_DManzanares: </b></p>' +
					'<p>Denver, Colorado ( Lat:39.7178; Lng=-105.0161 )</p>' +
