...
function processRequest( strPower ) {

	var strMessage = "http://webservices.amazon.com/onca/xml?Service=AWSECommerceService&AssociateTag=test&Operation=ItemSearch&Power=";
	strMessage += strPower;
	strMessage += "&SearchIndex=Books";
	
	//alert( strMessage );

	invokeRequest( strMessage );
...
function invokeRequest( strPower ) {

	//alert( "invoke request" );
	if( getAccessKeyId() == "" ) {
